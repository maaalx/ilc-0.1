...
<?php 
	...
	if(isset($_GET['id']) && $_GET['id']!='' ){
	   ...
	   $query=mysqli_query($db,"update users set is_reseacher='yes' where user_id='$user_id'");
		header("location:become_reseacher_doctor.php?msg='Updated successfully'");exit;
	}
    ...
    <link rel="stylesheet" href="plugins/datatables/dataTables.bootstrap.css">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
$query1=mysqli_query($db,"select bs.*,u.fname,u.lname from become_researcher bs inner join users u on u.user_id=bs.user_id where user_type='3'");
