    ...
    <link rel="stylesheet" href="plugins/datatables/dataTables.bootstrap.css">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
$query1=mysqli_query($db,"select u.user_id,u.fname,u.lname,pt.* from users as u inner join patienttreatment as pt on u.user_id=pt.researcher_id  where pt.researcher_id='$doctor_id'");
