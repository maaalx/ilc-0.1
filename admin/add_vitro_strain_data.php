...
<?php 	require_once("includes/header.php");
	...
	if(isset($_GET['vitro_id']) && $_GET['vitro_id']!=''){ 
		$vitro_id=addslashes($_GET['vitro_id']); 
	}else{
		$vitro_id=0;
	}
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- form start -->
                <form role="form" name="save_vitro_strain_data" id="save_vitro_strain_data" action="" enctype="multipart/form-data" method="post">  
				<input type="hidden" name="vitro_id" id="vitro_id" value="<?php echo $_GET['vitro_id']; ?>">
...
$("#save_vitro_strain_data").on('submit',(function(e) {
	$(".loading").show();
e.preventDefault();


$.ajax({
url: "ajax/save_vitro_strain_data.php", // Url to which the request is send
