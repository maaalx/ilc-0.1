    ...
    <link rel="stylesheet" href="plugins/datatables/dataTables.bootstrap.css">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
$query1=mysqli_query($db,"select * from users where doctor_id='$doctor_id'");
...
<a href="doctor_add_patient_history.php?user_id=<?php echo $row1['user_id']; ?>"><button style="width: auto;" class="btn-success disabled" name="approved">Add Treatment</button></a>
