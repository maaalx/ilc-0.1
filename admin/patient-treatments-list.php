    ...
    <link rel="stylesheet" href="plugins/datatables/dataTables.bootstrap.css">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
$query1=mysqli_query($db,"select pt.* from  patienttreatment as pt where 	patientId='$patient_id'");
...
<tr><td><?php echo $row1['idpatientTreatment']; ?></td>
...
<a href="view_treatment.php?treatment_id=<?php echo $row1['idpatientTreatment']; ?>"><button style="width: auto;" class="btn-success disabled" name="approved">View Detail</button></a>
