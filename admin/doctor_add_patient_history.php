          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<input type="hidden" name="patient_id" id="patient_id" value="<?php echo addslashes($_GET['user_id']) ?>">
 ...
 $(".loading").hide();	
  ...
  if( obj.error==1 ){
      $(".error").html(obj.msg);
		...
		window.location="doctor_add_treatment.php?user_id=<?php echo $_GET['user_id']; ?>&history_id="+obj.history_id;
  }
