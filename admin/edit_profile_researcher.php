...
<?php 	require_once("includes/header.php");
		...
		$ilc_id=$row['ilc_id'];
		$query=mysqli_query($db,"select * from researcher where ilc_id='$ilc_id'");
		$researcher=mysqli_fetch_assoc($query);
        ...
        <section class="content">
		  ...
		  <div class="form-group ">
				  ...
				  <div class="col-xs-6">
						<div class="form-group has-feedback">
						<label>Phone 1</label>
						<input value="<?php echo $researcher['phone1']; ?>" type="text" name="phone1" id="phone1" class="form-control" placeholder="Phone 1">
						
						</div>
					
						<div class="form-group has-feedback">
						<label>Phone 2(Work Phone Number)</label>
						<input value="<?php echo $researcher['phone2']; ?>" type="text" name="phone2" id="phone2" class="form-control" placeholder="Phone 2">
						
						</div>
						
						<div class="form-group has-feedback">
						<label>Institution_Name <span style="color:red">*</span></label>
						<input value="<?php echo $researcher['institution_name']; ?>" type="text" name="institution_name" id="institution_name" class="form-control" placeholder="Tax File Number">
						
						</div>
						
						<div class="form-group has-feedback">
						<label>Address Line 1 <span style="color:red">*</span></label>
						<input value="<?php echo $researcher['address_line_1']; ?>" type="text" name="address_line_1" id="address_line_1" class="form-control" placeholder="Address Line 1">
						
						</div>
						
						<div class="form-group has-feedback">
						<label>Address Line 2 </label>
						<input value="<?php echo $researcher['address_line_2']; ?>" type="text" name="address_line_2" id="address_line_2" class="form-control" placeholder="Address Line 2">
						
						</div>
						
						<div class="form-group has-feedback">
						<label>Suburb <span style="color:red">*</span></label>
						<input value="<?php echo $researcher['suburb']; ?>" type="text" name="suburb" id="suburb" class="form-control" placeholder="Suburb">
						
						</div>
						
						<div class="form-group has-feedback">
						<label>State <span style="color:red">*</span></label>
						<input value="<?php echo $researcher['state']; ?>" type="text" name="state" id="state" class="form-control" placeholder="State">
						
						</div>
						
						<div class="form-group has-feedback">
						<label>Postcode <span style="color:red">*</span></label>
						<input value="<?php echo $researcher['postcode']; ?>" type="text" name="postcode" id="postcode" class="form-control" placeholder="Postcode">
						...
						<select name="country" id="country" class="form-control">
							  ...
							  <?php $temp_query=mysqli_query($db,"select * from country order by name");
								...
								?>
								<option <?php if($researcher['country']==$c_row['iso'])echo "selected"; ?> value="<?php echo $c_row['iso']; ?>"><?php echo $c_row['name']; ?></option>
								<?php } ?>
							  </select>
...
$(document).ready(function (e) { 
	$("#update_user").on('submit',(function(e) {
		e.preventDefault();
				...
				$.ajax({
				url: "ajax/update_user_researcher.php", // Url to which the request is send
				...
				success: function(data)   // A function to be called if request succeeds
				{
				  ...
				  if( obj.error==1 ){
					 ...
					 window.location="edit_profile_researcher.php";
				  }
